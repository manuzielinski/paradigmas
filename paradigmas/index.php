...
<body>
    ...
    <div class="container">
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=nikbar4000">
        ...
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=nikbar1500">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=nikbar2500">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=nikbar6000">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=geekbar5000">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=mamma_pro_1000">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=mask_king_8000">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=nikbar8000">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
        <div class="card">
            ...
            <div class="btn">
                <a href="pages/producto.php?product=dozeup_600">
                    <button type="button">Comprar</button>
                </a>
            </div>
        </div>
